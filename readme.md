...
> [!IMPORTANT]  
> On AMD systems, avoid assigning multiple CPU cores or more than 8 GB of RAM initially. Depending on the specific AMD CPU model, it  may cause instability or reduces performance. Increase the RAM or core count only after macOS has been running reliably for several hours.
>
